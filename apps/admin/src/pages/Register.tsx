  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      if (DEV_MODE) {
        ...
        keycloak!.login({ redirectUri: `${window.location.origin}/setup` })
      }
    },
  })
  ...
  return (
    <div style={pageStyle}>
      ...
      <div style={{ padding: '48px 24px 40px', textAlign: 'center' }}>
        <p style={{
          color: '#6cf0c2', fontWeight: 700, fontSize: 11, letterSpacing: '0.15em',
        ...
        <form onSubmit={handleSubmit}>
          ...
          <p style={{ textAlign: 'center', marginTop: 20, color: '#a6b0c3', fontSize: 13 }}>
            ...
            <button
              ...
              style={{
                background: 'none', border: 'none', color: '#6cf0c2', cursor: 'pointer',
